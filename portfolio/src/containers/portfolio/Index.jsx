          ...
          >
            <SwiperSlide>
              ...
              <p>
                ...
                JavaScript und ausgeführt in einer Node.js-Umgebung, bei dem
                eine Person versucht, ein geheimes Wort zu erraten.
              </p>
            </SwiperSlide>
            <SwiperSlide>
            ...
            <SwiperSlide>
              ...
              <p>
                Dieses umfangreiche Projekt einer Netflix-Filmanwendung
                integriert nicht nur die OMDB API für den Abruf von Filmdaten,
                sondern enthält auch eine lokale Authentifizierung für eine
                Login-Seite. Ziel ist es, Benutzern eine personalisierte
                Erfahrung zu bieten, indem sie sich anmelden können, um ihre
                bevorzugten Filme zu speichern und mit anderen Benutzern zu
                interagieren.
              </p>
            </SwiperSlide>
            <SwiperSlide>
            ...
            <SwiperSlide>
              ...
              <p>
                ...
                Wetterinformationen basierend auf dem Standort des Benutzers
                oder einer ausgewählten Stadt anzeigt, wobei Funktionen wie die
                Anzeige von Temperatur, Wetterbedingungen, Luftfeuchtigkeit,
                Windgeschwindigkeit, Benutzereingabe für den Standort, Abrufen
                von Wetterdaten über eine Wetter-API, Anzeige eines
                Ladeindikators während des Abrufs und Fehlerbehandlung für
                fehlgeschlagene Datenabfragen enthalten sind.
              </p>
            </SwiperSlide>
            <SwiperSlide>
              ...
              <p>
                ...
                React-Komponenten-Lebenszyklen in einer Anwendung. Benutzer
                können die Namen von GitHub-Organisationen abrufen und
                durchsuchen und Details sowie Repositories der ausgewählten
                Organisationen anzeigen lassen.
              </p>
            </SwiperSlide>
            <SwiperSlide>
